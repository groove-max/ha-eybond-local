#!/usr/bin/env python3
"""Export a project-wide declarative support overview as JSON or Markdown."""
...
from custom_components.eybond_local.support.overview import (  # noqa: E402
...
def main() -> int:
    ...
    if args.format == "markdown":
        rendered = render_support_overview_markdown(overview)
    else:
