...
basic telemetry, a labelled AC-load estimate, and optional BMS/rated readings
where the device answers them. Live PV and inverter controls are absent. This
identifies the protocol family, not a retail commercial model. See its
