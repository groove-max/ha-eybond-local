...
|---|---|
| Автопошук нічого не знаходить | Повторіть пошук або виберіть інший мережевий інтерфейс Home Assistant. За потреби використайте розширене налаштування з IP колектора з роутера. |
...
| З’явився лише пристрій колектора | Визначення інвертора ще не завершилося. Зачекайте один цикл визначення; якщо інвертор не з’явиться, створіть архів підтримки. |
