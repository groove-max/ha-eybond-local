...
відповідними відповідями, дані BMS і номінальні параметри, а також
опційні сенсори PV/MPPT (вимкнені за замовчуванням). Керування відсутнє. Це
визначення сімейства протоколу, не роздрібної комерційної моделі. Дивіться
