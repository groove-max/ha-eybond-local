...
підтримки. **Розширити підтримку цього пристрою** може зібрати додаткові дані
...
1. Відкрийте **Налаштувати → Розширити підтримку цього пристрою**.
...
3. Якщо доступно кілька сумісних API, виберіть конкретне хмарне джерело для
   цього запуску.
4. Прочитайте попередження, якщо вибрано активну перевірку.
