...
Якщо ваш інвертор уже працює в SmartESS, ValueCloud або сумісному застосунку
виробника, є хороший шанс, що він запрацює і тут.
...
3. Увійдіть у підтримуваний хмарний акаунт для цього одного сеансу, якщо
   ...
   самий акаунт, який використовується у SmartESS, ValueCloud або сумісному
   застосунку виробника.
...
| Застосунок виробника перестав показувати дані | Перевірте режим колектора. **Тільки Home Assistant** навмисно відключає цей колектор від хмари. Перемкніть назад на **SmartESS + Home Assistant** / режим хмара + Home Assistant, якщо потрібен застосунок виробника. |
