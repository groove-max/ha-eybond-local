...
def default_enabled_runtime_number_keys_for_runtime(
    ...
    """Return menu-independent runtime number keys for entity self-healing.

    Proxy duration is owned by the proxy-capture options form. Exposing it as a
    second writable entity created two authorities for one session timer.
    """
