...
from ..metadata.profile_loader import load_driver_profile, profile_file_names
...
def build_support_overview(profile_names: tuple[str, ...] | None = None) -> dict[str, Any]:
    ...
    selected_profiles = profile_names or profile_file_names()
...
def render_support_overview_markdown(overview: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "| Profile | Key | Driver | Family | Capabilities | Tested | Untested | Conditional | Blocked |",
        "|---|---|---|---|---:|---:|---:|---:|---:|",
    ]
