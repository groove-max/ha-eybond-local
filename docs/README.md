...
- [Inverter Model Catalog](generated/INVERTER_MODEL_CATALOG.generated.md) — maintained commercial model support journal
- [Inverter Model Catalog And Journal Plan](INVERTER_MODEL_CATALOG_PLAN.md) — maintainer plan for the commercial model catalog, evidence references, generated journal, and runtime boundaries
...
- [Inverter Model Catalog](generated/INVERTER_MODEL_CATALOG.generated.md) — commercial model journal generated from `catalog/inverter_models/` and the runtime inverter catalog
