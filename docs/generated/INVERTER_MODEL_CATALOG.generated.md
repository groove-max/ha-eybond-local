...
- Validation: hardware captured, telemetry confirmed, controls partial
- Coverage: runtime available, SmartESS unknown, vendor map partial
  - Coverage notes:
    - Owner-supplied OP2 register list covers the second-output extension, not the full vendor register map.
    - Only the OP2 enable write is independently hardware-confirmed.
...
- Validation: hardware captured, telemetry confirmed, controls confirmed
- Coverage: runtime hardware_confirmed, SmartESS not_applicable, vendor map unknown
  - Coverage notes:
    - PI30 runtime control surface is validated from the VMII-NXPW5KW live-capture fixture.
