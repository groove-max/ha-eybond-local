...
| MUST | PV18-3024 | must_pv_ph18 | anchors | full | partial | none | captured |
...
- Coverage: runtime available, cloud cloud_catalog, vendor map partial
  - Coverage notes:
    - Runtime support uses the MUST PH RS485 map (v1.4.3 xlsx, cross-checked against the third-party implementation); controls from the settings block ship untested and appear only in full-control mode.
