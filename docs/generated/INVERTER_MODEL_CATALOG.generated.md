...
| Manufacturer | Model | Protocol | Detection | Runtime Tier | Telemetry | Controls | Hardware |
|---|---|---|---|---|---|---|---|
| Anenji | 4200 (Protocol 1) | modbus_smg | fingerprint | full | partial | none | reported |
...
### Anenji — 4200 (Protocol 1) (`anenji_4200_protocol_1`)

- Lifecycle: experimental
- Aliases: —
- Validation: hardware reported, telemetry partial, controls none
- Summary: Anenji 4200 Protocol 1 variant carried over from legacy detection rules; a full runtime surface exists but lacks a current hardware capture.
- Variants:
...
- Known limitations:
  - Migrated from legacy detection rules; not validated on current hardware.
- Evidence: 1 source(s)
  - Public references: —
  - Sanitized summaries:
    - Anenji 4200 (Protocol 1) rule migration note: Anenji 4200 (Protocol 1) variant migrated from legacy detection rules; a full runtime surface exists but no hardware capture is on file.
